...
Write a function that searches for a value in a sorted array of integers using the [Binary search algorithm](/rltoken/SnveFJhSDE7o8bEx-kGGpA "Binary search algorithm")
...
#### Students who are done with "5. Big O #3"
